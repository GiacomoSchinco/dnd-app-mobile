const obsidianTheme = {
  ...
  typography: {
    ...
    tight: 1.2, normal: 1.5, relaxed: 1.75, tighter: -0.5, tight_ls: -0.3, normal_ls: 0, wide: 0.3,
  },
  ...
  shadow: {
    ...
    md: { shadowColor: '#8B5CF6', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 12, elevation: 6 },
    lg: { shadowColor: '#8B5CF6', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.4, shadowRadius: 24, elevation: 12 },
  },
  animation: {
    spring: { gentle: { damping: 20, stiffness: 180 }, snappy: { damping: 18, stiffness: 300 }, bouncy: { damping: 12, stiffness: 200 } },
    duration: { fast: 150, normal: 250, slow: 400 },
  },
  gradients: {
    background: { colors: ['#0D0D0D', '#1A1A1A'], direction: 'vertical' },
    accent: { colors: ['#8B5CF6', '#A78BFA'], direction: 'vertical' },
    card: { colors: ['#1A1A1A', '#242424'], direction: 'vertical' },
    surface: { colors: ['#1A1A1A', '#262626'], direction: 'vertical' },
  },
